...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        octo_models.Workout.objects.create(name='Hero HIIT', description='High intensity for heroes', suggested_for_team=marvel)
        octo_models.Workout.objects.create(name='Justice Jog', description='Endurance for justice', suggested_for_team=dc)
